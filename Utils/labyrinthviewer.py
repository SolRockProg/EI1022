...
Vertex ="Vertex"  #= Tuple[int, int]
Edge = "Edge" #Tuple[Vertex, Vertex]
...
class LabyrinthViewer(EasyCanvas):
    ...
    def add_path(self, path, color: str = 'red', offset: int = 0):
        self.paths.append((path, color, offset))

    def _draw_path(self, path, color: str, offset: int):
        u = path[0]
...
if __name__ == '__main__':
    ...
    # Sesiones 1 y 2 en forma de grafo no dirigido
